...
import { FaArrowCircleUp, FaCheckCircle, FaChevronDown, FaClock, FaEye, FaFileUpload, FaFilter, FaPlusCircle, FaSearch } from 'react-icons/fa'
    ...
    <div>
      ...
      <main className='container px-3 d-flex flex-column justify-content-center align-items-center pt-5'>
        ...
        <div className="mt-4 w-100">
          <PostCard score="123" comments="4" chain="BSC" title="Farm The Dip JUST Launched 🚀" date="3 Days Ago" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat..." />
          <PostCard score="42" comments="2" chain="ETH" title="Trident Token presale goes live in 3 DAYS! 🎉🥳" date="12 Hours Ago" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat..." />
          <PostCard />
        </div>
      </main>
    </div>
